...
typedef struct CSPAQ13700InBlock1data
{
    char    *RecCnt              ;    // [long  ,    5] 레코드갯수                      StartPos 0, Length 5
    char    *AcntNo              ;    // [string,   20] 계좌번호                        StartPos 5, Length 20
    char    *InptPwd             ;    // [string,    8] 입력비밀번호                    StartPos 25, Length 8
    char    *OrdMktCode          ;    // [string,    2] 주문시장코드                    StartPos 33, Length 2
    char    *BnsTpCode           ;    // [string,    1] 매매구분                        StartPos 35, Length 1
    char    *IsuNo               ;    // [string,   12] 종목번호                        StartPos 36, Length 12
    char    *ExecYn              ;    // [string,    1] 체결여부                        StartPos 48, Length 1
    char    *OrdDt               ;    // [string,    8] 주문일                          StartPos 49, Length 8
    char    *SrtOrdNo2           ;    // [long  ,   10] 시작주문번호2                   StartPos 57, Length 10
    char    *BkseqTpCode         ;    // [string,    1] 역순구분                        StartPos 67, Length 1
    char    *OrdPtnCode          ;    // [string,    2] 주문유형코드                    StartPos 68, Length 2
} CSPAQ13700InBlock1data;
