...
typedef struct _CSPAQ12300InBlock1data
{
    char    *RecCnt              ;    // [long  ,    5] 레코드갯수                      StartPos 0, Length 5
    char    *AcntNo              ;    // [string,   20] 계좌번호                        StartPos 5, Length 20
    char    *Pwd                 ;    // [string,    8] 비밀번호                        StartPos 25, Length 8
    char    *BalCreTp            ;    // [string,    1] 잔고생성구분                    StartPos 33, Length 1
    char    *CmsnAppTpCode       ;    // [string,    1] 수수료적용구분                  StartPos 34, Length 1
    char    *D2balBaseQryTp      ;    // [string,    1] D2잔고기준조회구분              StartPos 35, Length 1
    char    *UprcTpCode          ;    // [string,    1] 단가구분                        StartPos 36, Length 1
} CSPAQ12300InBlock1data;
