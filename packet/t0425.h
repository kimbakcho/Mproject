...
typedef struct _t0425InBlockdata
{
    char    *accno               ;    // [string,   11] 계좌번호                        StartPos 0, Length 11
    char    *passwd              ;   // [string,    8] 비밀번호                        StartPos 12, Length 8
    char    *expcode             ;    // [string,   12] 종목번호                        StartPos 21, Length 12
    char    *chegb               ;    // [string,    1] 체결구분                        StartPos 34, Length 1
    char    *medosu              ;    // [string,    1] 매매구분                        StartPos 36, Length 1
    char    *sortgb              ;    // [string,    1] 정렬순서                        StartPos 38, Length 1
    char    *cts_ordno           ;   // [string,   10] 주문번호                        StartPos 40, Length 10
} t0425InBlockdata;
...
typedef struct{
            t0425OutBlock	OutBlock;
            char				sCountOutBlock1[5];
            t0425OutBlock1	OutBlock1[1];
} t0425AllOutBlock, *LPtt0425AllOutBlock;
