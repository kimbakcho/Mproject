...
typedef struct _t0424InBlockdata
{
    char    *accno           ;        // [string,   11] 계좌번호                        StartPos 0, Length 11
    char    *passwd          ;      // [string,    8] 비밀번호                        StartPos 12, Length 8
    char    *prcgb           ;      // [string,    1] 단가구분                        StartPos 21, Length 1
    char    *chegb           ;     // [string,    1] 체결구분                        StartPos 23, Length 1
    char    *dangb           ;    // [string,    1] 단일가구분                      StartPos 25, Length 1
    char    *charge          ;   // [string,    1] 제비용포함여부                  StartPos 27, Length 1
    char    *cts_expcode     ;// [string,   22] CTS_종목번호                    StartPos 29, Length 22
} t0424InBlockdata;
...
typedef struct{
            t0424OutBlock	OutBlock;
            char				sCountOutBlock1[5];
            t0424OutBlock1	OutBlock1[1];
} t0424AllOutBlock, *LPtt0424AllOutBlock;
